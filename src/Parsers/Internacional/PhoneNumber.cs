...
namespace Parsers.Internacional
{
    ...
    // TODO: Add a ParseExact() implementation.
    // TODO: Add a TryParseExact() implementation.
    ...
    public struct PhoneNumber : IComparable, IFormattable, ISerializable
    {
        ...
        private static void _Parse(ref string value, out int countryCode, out int npaCode, out int nxxCode, out int stationCode, out int extension, out string phonetic, bool allowPhonetic, IFormatProvider formatProvider)
        {
            countryCode = 0;
            npaCode = 0;
            nxxCode = 0;
